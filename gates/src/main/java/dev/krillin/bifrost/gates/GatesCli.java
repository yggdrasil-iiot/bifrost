 ...
 * Usage: gates &lt;schema|spec|template|adapt-template|policy|provenance&gt; &lt;args...&gt;
 */
public final class GatesCli {
    ...
    public static int run(String[] args) {
        if (args.length == 0) {
            System.err.println("Usage: gates <schema|spec|template|adapt-template|policy|provenance> <args...>");
            return 2;
        }
        String sub = args[0];
