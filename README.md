...
![Tests](https://img.shields.io/badge/tests-399-brightgreen)
...
| **[Executable gates](#executable-gates)** | Every claim below is backed by a gate you can run, not by a unit test. All 17 last ran green on **2026-09-08** (Docker 26.1.4), with no leg skipped. |
...
```bash
mvn install     # Java 17 · 399 tests (core 223 · heimdall 82 · gates 76 · sim 18)
